...
%                   functions in the final model (Friedman 1991). While
%                   building a model, the number may also not be reached
%                   because the number of coefficients in the model cannot
%                   exceed the number of input data cases (or because of
