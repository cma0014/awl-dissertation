...
% areseq
% Outputs an ARES model in an explicit mathematical form (useful e.g. for
...
if model.trainParams.cubic
    disp('Warning: The model is piecewise-cubic. Only piecewise-linear basis functions will be outputted.');
end
