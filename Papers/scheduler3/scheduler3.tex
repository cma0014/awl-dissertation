...
\markboth{Adam Wade Lewis, et. al}{Thermally-aware Fair Scheduling and
  Load Balancing Using Predictive Energy  Consumption Models in High-Performance Systems}
...
\keywords{Analysis of variance, chaotic time series, energy consumption,
  HyperTransport bus, performance counters, QuickPath links,
