%
%  $Author: awl8049 $
%  $Date: 2009/06/06 19:24:36 $
%  $Revision: 1.2 $
%
\documentclass[]{sig-alternate-hotpower09}
\usepackage{setspace}
\usepackage{times}
\usepackage{graphicx}
...
\affaddr{Center for Advanced Computer Studies}\\
\affaddr{University of Louisiana, Lafayette, Louisiana 70504}\\
\email{\{awlewis,sxg5317,tzeng\}@cacs.louisiana.edu}
}
\maketitle
\newtheorem{defn}{Definition}
\newtheorem{thm}{Theorem}
\newdef{algorithm}{Algorithm}
\thispagestyle{empty}
%\doublespacing
\begin{abstract}
